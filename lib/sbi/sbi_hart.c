		     ...
		     bool next_virt)
{
	...
	EFI_SECURE_SHARED_BUFFER *MmSharedBuffer = (EFI_SECURE_SHARED_BUFFER *)0x82200000;
	...
	register unsigned long a1 asm("a1") = (unsigned long)&MmSharedBuffer->MmPayloadBootInfo;
